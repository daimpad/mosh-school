...
const SCHEMATA = {
  gitarre_bass: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 120" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><polygon points="46,42 10,36 2,45 2,67 10,76 46,70" stroke-width="2.5"/><circle cx="15" cy="46" r="2.2" stroke-width="1.6"/><circle cx="25" cy="47" r="2.2" stroke-width="1.6"/><circle cx="35" cy="48" r="2.2" stroke-width="1.6"/><circle cx="15" cy="66" r="2.2" stroke-width="1.6"/><circle cx="25" cy="65" r="2.2" stroke-width="1.6"/><circle cx="35" cy="64" r="2.2" stroke-width="1.6"/><rect x="46" y="42" width="3.5" height="28" rx="1" fill="currentColor" stroke="none"/><line x1="17" y1="46" x2="48" y2="45" stroke-width="0.7" opacity="0.55"/><line x1="27" y1="47" x2="48" y2="49" stroke-width="0.7" opacity="0.55"/><line x1="37" y1="48" x2="48" y2="53" stroke-width="0.7" opacity="0.55"/><line x1="37" y1="64" x2="48" y2="57" stroke-width="0.7" opacity="0.55"/><line x1="27" y1="65" x2="48" y2="61" stroke-width="0.7" opacity="0.55"/><line x1="17" y1="66" x2="48" y2="65" stroke-width="0.7" opacity="0.55"/><path d="M49.5,42 L150,46 L150,68 L49.5,70 Z" stroke-width="2"/><line x1="68" y1="43" x2="68" y2="70" stroke-width="1.3"/><line x1="87" y1="43.5" x2="87" y2="69.5" stroke-width="1.3"/><line x1="106" y1="44" x2="106" y2="69" stroke-width="1.3"/><line x1="125" y1="44.5" x2="125" y2="68.5" stroke-width="1.3"/><line x1="144" y1="45" x2="144" y2="68" stroke-width="1.3"/><circle cx="96" cy="56.5" r="1.6" fill="currentColor" stroke="none"/><circle cx="134" cy="56.5" r="1.6" fill="currentColor" stroke="none"/><path d="M150,46 L300,20 L232,57 L300,94 L150,68 Z" stroke-width="2.5"/><line x1="49.5" y1="47" x2="226" y2="49" stroke-width="0.8"/><line x1="49.5" y1="51" x2="226" y2="52" stroke-width="0.9"/><line x1="49.5" y1="55" x2="226" y2="55" stroke-width="1"/><line x1="49.5" y1="59" x2="226" y2="58" stroke-width="1.1"/><line x1="49.5" y1="63" x2="226" y2="61" stroke-width="1.2"/><line x1="49.5" y1="67" x2="226" y2="64" stroke-width="1.3"/><rect x="184" y="42" width="12" height="28" rx="2" stroke-width="2"/><rect x="204" y="42" width="12" height="28" rx="2" stroke-width="2"/><rect x="226" y="47" width="8" height="20" rx="1.5" stroke-width="2"/><circle cx="214" cy="75" r="3.4" stroke-width="1.8"/><circle cx="228" cy="77" r="3.4" stroke-width="1.8"/><rect x="246" y="79" width="8" height="6" rx="1.5" fill="currentColor" stroke="none"/><g class="hotspot" data-region="korpus" data-baustein="bauform_ergonomie" role="button" tabindex="0"><title>Korpusform</title><rect x="150" y="16" width="162" height="88" rx="4" fill="transparent"/></g><g class="hotspot" data-region="sattel" data-baustein="sattel_typen" role="button" tabindex="0"><title>Kopfplatte &amp; Sattel</title><rect x="4" y="26" width="54" height="66" rx="3" fill="transparent"/></g><g class="hotspot" data-region="hals" data-baustein="saitenlage_setup" role="button" tabindex="0"><title>Hals, Bünde &amp; Saitenlage</title><rect x="56" y="38" width="92" height="40" rx="3" fill="transparent"/></g><g class="hotspot" data-region="saiten" data-baustein="saiten_mensur" role="button" tabindex="0"><title>Saiten &amp; Mensur</title><rect x="152" y="44" width="34" height="28" rx="3" fill="transparent"/></g><g class="hotspot" data-region="tonabnehmer" data-baustein="tonabnehmer_typen" role="button" tabindex="0"><title>Tonabnehmer</title><rect x="182" y="40" width="40" height="34" rx="3" fill="transparent"/></g><g class="hotspot" data-region="steg" data-baustein="steg_typen" role="button" tabindex="0"><title>Steg / Brücke</title><rect x="222" y="44" width="26" height="30" rx="3" fill="transparent"/></g><g class="hotspot" data-region="plektrum" data-baustein="plektren_saitenpflege" role="button" tabindex="0"><title>Anschlag &amp; Plektrum</title><rect x="180" y="72" width="84" height="30" rx="3" fill="transparent"/></g></svg>`,
...
const QUERLINKS = {
  mikrofon_typen: ['mikrofontechnik', 'mikrofon_harsh'],
  proberaum_ausruestung: ['show_lautstaerke_gehoer'],
  bauform_ergonomie: ['bauform_und_bauteilpaket', 'bauform_kultur_buehne'],
};
...
export function renderWerkzeugExplorer(el, daten, query) {
  ...
  el.innerHTML = `
    <article class="wz-werkzeug">
      ...
      <h2 class="abschnitt-titel">${esc(t('zerrtypen_titel'))}</h2>
      <a class="karte karte-link geraete-eintrag" href="#/zerrtypen">
        <span class="geraete-eintrag-icon"><i class="fa-solid fa-wave-square" aria-hidden="true"></i></span>
        <span class="geraete-eintrag-text">${esc(t('zerrtypen_untertitel'))}</span>
